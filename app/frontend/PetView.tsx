      ...
      <div className="min-h-screen bg-gray-100 p-8">
        ...
        <div className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-xl">
          ...
          <div className="space-y-4">
            ...
            <p><strong>เพศ:</strong> <span className="text-green-600 font-semibold">{item.petSex === 'M' ? 'Male' : 'Female'}</span></p>
            <p><strong>ประเภทสัตว์เลี้ยง:</strong> <span className="text-green-600 font-semibold">{item.petType === 10 ? 'สุนัข' : item.petType === 20 ? 'แมว' : item.petType === 30 ? 'สิงโต' : 'อื่นๆ'}</span></p>
        ...
        <PetFooter stdname="Wirawat Lueasap" fburl="wirawat.lue@rmutto.ac.th" />
      </div>
    </>
  );
}